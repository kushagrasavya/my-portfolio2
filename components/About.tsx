        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 w-full mt-24 md:mt-40">
          ...
          <div className="col-span-1 md:col-span-7 md:col-start-6 flex flex-col gap-12 pt-4">
            <h3 className="text-2xl md:text-3xl lg:text-[2.2rem] font-medium leading-snug text-[#d1d1c7] max-w-[30ch]">
              I’m a Computer Science student blending full-stack engineering with marketing to build digital experiences that actually convert.
            </h3>
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-16 pt-4 border-t border-[#393632]">
              ...
              <div className="flex flex-col gap-6 text-base md:text-lg font-medium leading-relaxed text-[#a9a9a9] max-w-[45ch]">
                <p>
                  I’m a Computer Science student blending full-stack engineering with marketing. I like building digital experiences that actually convert, which means I don't just run the marketing campaigns, I build the actual platforms they point to..
                </p>
                <p>
                  Most of my time outside of classes is spent building in the real world. I recently developed and launched the official website for Minerva Innov. Right now, I am architecting the custom registration funnels and the official website for their upcoming x initiative, while also designing the entire go-to-market strategy to drive day-one growth.
                  <br></br><br></br>
                  I’m not too hung up on making things perfect on the first try. I love breaking down user behavior to see exactly why something clicks, but I’d much rather ship a product quickly, test it, and improve it from there. Code the tech, build the hype, make it better.
                </p>
              </div>
            </div>
